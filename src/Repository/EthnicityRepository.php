...
/**
 * @extends ServiceEntityRepository<Ethnicity>
 *
...
class EthnicityRepository extends ServiceEntityRepository
{
    ...
    public function save(Ethnicity $entity, bool $flush = false): void
    {
    ...
    public function remove(Ethnicity $entity, bool $flush = false): void
    {
